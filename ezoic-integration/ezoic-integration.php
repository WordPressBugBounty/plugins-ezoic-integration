...
if ( ! defined( 'EZOIC_INTEGRATION_VERSION' ) ) {
	define( 'EZOIC_INTEGRATION_VERSION', '2.22.11' ); // also update version in 'class-ezoic-integration-factory.php'.
}
...
define( 'EZOIC_ANALYTICS_SCRIPT_URL', '//ezoicanalytics.com/analytics.js' );
