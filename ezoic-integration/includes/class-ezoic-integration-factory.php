...
namespace Ezoic_Namespace {
	if ( ! defined( 'EZOIC_INTEGRATION_VERSION' ) ) {
		define( 'EZOIC_INTEGRATION_VERSION', '2.22.11' ); // update plugin version number
	}
	...
	class Ezoic_Integration_Factory {
		...
		/**
		 * Checks if the request is coming from a cloud integrated environment.
		 *
		 * @return bool
		 */
		public static function is_cloud_request() {
		...
		public static function bypass_middleware() {
			$cloud_integrated = self::is_cloud_request();
